...
public class SettingAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setprofile=findViewById(R.id.setting_profile);
        setname=findViewById(R.id.setting_name);
        setstatus=findViewById(R.id.setting_status);
        donebtn=findViewById(R.id.setting_donebtn);
                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(SettingAct.this, "Data Saved", Toast.LENGTH_SHORT).show();
                                                Intent intent=new Intent(SettingAct.this,MainActivity.class);
                                                startActivity(intent);
                                                finish();
                                            }else {
                                                Toast.makeText(SettingAct.this, "Error occurs...", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
